...
public class TodosJuntosTest {
	private static final int REPETICIONES = 10000;
	private static final boolean BOTE = true;
	private static final String NOMBRES[] = {"Juanito", "Juan", "Juanote", "Pepito", "Pepe", "Pepote", "Menganito", "Mengano", "Menganote"};
